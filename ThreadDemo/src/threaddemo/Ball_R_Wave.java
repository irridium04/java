...
public class Ball_R_Wave extends JComponent implements Runnable
{
    ...
    public Ball_R_Wave(int bSize, int bXpos, int bYpos, int bSpeed, int bcWidth, int bcHeight, int bRise, int bRun) {
        this.bSize = bSize;
        this.bXpos = bXpos;
        this.bYpos = bYpos;
        this.bSpeed = bSpeed;
    ...
    void MoveBall()
    {
        ...
        bYpos = (int) ((int) wAmplitude * Math.sin(wAngle) / 1 + (bcHeight / 2 - 10));
